...
function sampev.onShowDialog(id, style, title, button1, button2, text)
    ...
    if not buy_settings.buy_bool then
        if id == 4427 and (title:find('24/7') or title:find('Бар') or title:find('Стрип%-клуб') or title:find('Закусочная Burger Shot') or title:find('Закусочная Rusty Brown') or title:find('Закусочная Cluckin Bell') or title:find('Закусочная Pizzeria')) then
        ...
        if not buy_settings.find then
            if id == 4427 and ((title:find('24/7') and text:find('Телефон')) or (title:find('Бар') and text:find('Спранк')) or (title:find('Стрип%-клуб') and text:find('Темное пиво')) or (title:find('Закусочная Burger Shot') and text:find('Бургер %(еда%)')) or (title:find('Закусочная Rusty Brown') and text:find('Пончик')) or (title:find('Закусочная Cluckin Bell') and text:find('Ролл Цезарь')) or (title:find('Закусочная Pizzeria') and text:find('Кусок пиццы'))) then
...
function size_check(title)
    ...
    --sampAddChatMessage(textSizeX, -1)
