...
function sampev.onShowDialog(id, style, title, button1, button2, text)
    ...
    if not buy_settings.buy_bool then
        if id == 4427 and (title:find('24/7') or title:find('Бар') or title:find('Стрип%-клуб')) then
        ...
        if not buy_settings.find then
            if id == 4427 and ((title:find('24/7') and text:find('Телефон')) or (title:find('Бар') and text:find('Спранк')) or (title:find('Стрип%-клуб') and text:find('Темное пиво'))) then
